-- ============================================================
-- TALLER PRACTICO: BASE DE DATOS DE UNA TIENDA
-- Base de datos inicial para resolver el taller
-- ============================================================
...
-- ------------------------------------------------------------
-- Tabla Venta, relacionada con Producto mediante llave foranea
-- ------------------------------------------------------------
CREATE TABLE Venta (
    id INT PRIMARY KEY,
    id_producto INT,
...
-- ============================================================
-- FIN DEL SCRIPT
-- A partir de aqui, resuelve tu el taller con tus propias consultas.
-- ============================================================
